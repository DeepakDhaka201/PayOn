...
import 'withdraw_status_model.dart';
export 'withdraw_status_model.dart';

class WithdrawStatusWidget extends StatefulWidget {
  const WithdrawStatusWidget({
    super.key,
  ...
  @override
  State<WithdrawStatusWidget> createState() => _WithdrawStatusWidgetState();
}

class _WithdrawStatusWidgetState extends State<WithdrawStatusWidget> {
  late WithdrawStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WithdrawStatusModel());
  }
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Your order is in processing. Please wait for some time to settle this transaction.',
