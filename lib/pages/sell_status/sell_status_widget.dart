...
import 'sell_status_model.dart';
export 'sell_status_model.dart';
...
class SellStatusWidget extends StatefulWidget {
  ...
  @override
  State<SellStatusWidget> createState() => _SellStatusWidgetState();
}

class _SellStatusWidgetState extends State<SellStatusWidget> {
  late SellStatusModel _model;
