                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowRadioButton(
                                  options: _model.allModes.isNotEmpty
                                      ? _model.allModes
                                      : functions
                                          .returnEmptyList()!
                                          .map((e) => e.toString())
                                  ...
                                  onChanged: (val) async {
                                    ...
                                    if (_model.radioButtonValue !=
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'This option is avilabale for agents only.',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                    ...
                                    _model.payMode = _model.radioButtonValue!;
