...
import 'buy_status_copy_model.dart';
export 'buy_status_copy_model.dart';

class BuyStatusCopyWidget extends StatefulWidget {
  const BuyStatusCopyWidget({
    super.key,
  ...
  @override
  State<BuyStatusCopyWidget> createState() => _BuyStatusCopyWidgetState();
}

class _BuyStatusCopyWidgetState extends State<BuyStatusCopyWidget> {
  late BuyStatusCopyModel _model;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'An agent will review your deposit. Once confirmed, tokens will be added to your wallet.',
