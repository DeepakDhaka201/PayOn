...
class _ReferralWidgetState extends State<ReferralWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultRefInfo = await LoggedInGroup.referralInfoCall.call(
        apiToken: currentAuthenticationToken,
      );

      if ((_model.apiResultRefInfo?.succeeded ?? true)) {
                                          ...
                                          builder: (context) {
                                            ...
                                            if (referrals.isEmpty) {
                                              return const TextWidget(
                                                text:
                                                    'No active referrals. Do it now to earn profit',
                                              );
                                            }
