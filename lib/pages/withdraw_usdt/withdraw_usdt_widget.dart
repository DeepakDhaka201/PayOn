...
import '/components/wallet_pin_widget.dart';
...
import 'withdraw_usdt_model.dart';
...
class _WithdrawUsdtWidgetState extends State<WithdrawUsdtWidget> {
  late WithdrawUsdtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WithdrawUsdtModel());
            ...
            child: Stack(
              children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Enter your  USDT trc20 address.',
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 80.0, 20.0, 40.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        var shouldSetState = false;
                        if (_model.amountUsdtTextController.text != '') {
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: const WalletPinWidget(),
                              ),
                            );
                          },
                        ).then((value) =>
                            safeSetState(() => _model.walletPinResp = value));

                        shouldSetState = true;
                        if (_model.walletPinResp != null &&
                            _model.walletPinResp != '') {
                          _model.initiateWdtResp =
                              await LoggedInGroup.initiateWithdrawCall.call(
                            amountUsdt: double.tryParse(
                                _model.amountUsdtTextController.text),
                            walletPin: _model.walletPinResp,
                            address: _model.textController2.text,
                            apiToken: currentAuthenticationToken,
                          );

                          shouldSetState = true;
                          if ((_model.initiateWdtResp?.succeeded ?? true)) {
                            context.pushNamed(
                              'WithdrawStatus',
                              queryParameters: {
                                'transaction': serializeParam(
                                  getJsonField(
                                    (_model.initiateWdtResp?.jsonBody ?? ''),
                                    r'''$.transaction''',
                                  ),
                                  ParamType.JSON,
                                ),
