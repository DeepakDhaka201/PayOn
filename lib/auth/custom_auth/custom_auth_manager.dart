...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    payOnAuthUserSubject.add(
      PayOnAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PayOnAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PayOnAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PayOnAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    payOnAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
